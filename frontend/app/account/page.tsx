    ...
    return (
        <main className="min-h-screen bg-background pt-24 pb-20">
            <div className="container mx-auto px-6">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-white mb-2">Tài Khoản Của Tôi</h1>
                    <p className="text-muted-foreground">
                        Xin chào, <span className="text-white font-bold">{user.username}</span>!
                    </p>
                </div>
                        ...
                        <div className="bg-card/50 backdrop-blur-sm border border-white/5 rounded-2xl p-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <div className="font-bold text-white mb-1">Đăng Ký Lái Thử</div>
                                ...
                                >
                                    <div className="text-3xl mb-2">🔍</div>
                                    <div className="font-bold text-white mb-1">Xem Sản Phẩm</div>
                                ...
                                >
                                    <div className="text-3xl mb-2">📋</div>
                                    <div className="font-bold text-white mb-1">Lịch Sử Yêu Cầu</div>
                                ...
                                >
                                    <div className="text-3xl mb-2">💬</div>
                                    <div className="font-bold text-white mb-1">Liên Hệ</div>
